							...
							<div class="product-options">
								<label>
									...
									<select class="input-select" name="size">
										<option value="{{$product->size->size ?? 'null'}}">{{$product->size->size ?? 'null'}}</option>
									</select>
								</label>
								<label>
									Color
									<select class="input-select" name="color">
										<option value="{{$product->color->color ?? 'null'}}">{{$product->color->color ?? 'null'}}</option>
									</select>
								</label>
							</div>
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							...
							<div class="product-body">
								<p class="product-category">{{$related_product->category->name ?? 'null'}}</p>
